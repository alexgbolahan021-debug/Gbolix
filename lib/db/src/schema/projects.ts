...
export const projectsTable = pgTable("projects", {
  ...
  status: text("status", { enum: ["pending_review", "needs_info", "approved", "declined", "agreement_sent", "agreement_accepted", "in_progress", "review", "completed"] }).notNull().default("pending_review"),
