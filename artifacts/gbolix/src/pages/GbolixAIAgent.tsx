...
function AgentDetail({ agent, wallet, tab, setTab, onBack, onNew, form, setForm, knowledge, knowledgeForm, setKnowledgeForm, usage, chat, message, setMessage, deployment, onCreate, onSave, onAddKnowledge, onRemoveKnowledge, onSend, onResetChat, onDeploy, busy, goTo }: any) {
