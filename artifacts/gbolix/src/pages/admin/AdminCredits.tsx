...
function valueLabel(values: Money[]) {
  return values.length ? values.map(value => `${value.currency} ${value.amount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`).join(" · ") : "—";
}
